package com.clicknship.cart.controller;
...
public class ShoppingCartController extends BaseController {
	...
	public ResponseEntity<ShoppingCartDTO> createShoppingCart(@RequestBody(required = true) ShoppingCartDTO shoppingCartDTO) {
	...
	public ResponseEntity<ShoppingCartProductDTO> createShoppingCartProduct(@RequestBody(required = true) ShoppingCartProductDTO shoppingCartProductDTO) {
	...
	public ResponseEntity<ShoppingCartProductDTO> getShoppingCartProduct(@PathVariable Long shoppingCartProductID) throws BusinessException {
		...
		return result.map(shoppingCartProduct -> ResponseEntity.ok().body(shoppingCartProduct)).orElseGet(() -> ResponseEntity.notFound().build());
	}
	...
	public ResponseEntity<Void> deleteShoppingCartProduct(@PathVariable("shoppingCartID") @NotNull Long shoppingCartID, @PathVariable("productID") @NotNull Long productID) {
	...
	public ResponseEntity<Void> deleteShoppingCartProductById(@PathVariable("shoppingCartProductID") @NotNull Long shoppingCartProductID) {
