...
*/
INSERT INTO authdb.tb_security_user (`ID`,`USERNAME`,`PASSWORD`,`USER_ID`,`ENABLED`) VALUES (1,'james','$2a$12$65aXCVGoNocErfoa0oGbNuVT6eZIc5L2MANKb3Q2200lHrumUiBH.','1','A');
INSERT INTO authdb.tb_security_user (`ID`,`USERNAME`,`PASSWORD`,`USER_ID`,`ENABLED`) VALUES (2,'clicknship','$2a$12$wc1L3Qkbu7hIK39qQS0nFOzTMz3d3LBX2jVZOu3ciVJ06DUOyC0Xa','2','A');
...
INSERT INTO `userdb`.`tb_user` (`ID`, `CARD_NUMBER`, `NAME`, `EXPIRY`, `ADDRESS`, `CONTACT_DETAIL`) VALUES ('1', '1', 'james', '1', '1', '1');
INSERT INTO `userdb`.`tb_user` (`ID`, `CARD_NUMBER`, `NAME`, `EXPIRY`, `ADDRESS`, `CONTACT_DETAIL`) VALUES ('2', '2', 'clicknship', '2', '2', '2');

CREATE USER 'clicknship' IDENTIFIED WITH mysql_native_password BY 'clicknship';
GRANT ALL PRIVILEGES ON *.* TO 'clicknship';
